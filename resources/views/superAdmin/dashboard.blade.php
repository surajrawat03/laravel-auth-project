...
@section('content')
<div class="col col-md-8 col-lg-8 col-xl-8 pt-5 my-0 mx-auto">
    @if(session('success'))
    ...
    @endif
    <div class="card">
        <div class="card-header text-center">{{ __('Create New User') }}</div>

        <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
                @csrf
                <input type="hidden" name="createUserWithoutLogin" value="1">
